...
const LIGHT = {
  bg: "#FFFFFF", surface: "#F5F3FF", heading: "#1A0533", body: "#3D2C6B",
  muted: "#8B7AA8", card: "#FFFFFF", cardBorder: "#E9E3F5",
};
const DARK = {
  bg: "#0F0F13", surface: "#1A1A24", heading: "#F3F0FF", body: "#C4B5FD",
  muted: "#6B6B8A", card: "#1A1A24", cardBorder: "#2D2D3D",
};

const allAnnouncements = [
  { id: 1, text: "Water supply off tomorrow 10am–2pm for maintenance. Please store water in advance.", time: "2 hours ago" },
  { id: 2, text: "New WiFi password: PG@Sunrise2025. Old password has been deactivated from tonight.", time: "Yesterday, 8:30 PM" },
  { id: 3, text: "Rent reminder: Please clear February rent before 7th to avoid a late fee of ₹200.", time: "3 days ago" },
  { id: 4, text: "Common area deep cleaning scheduled for Sunday 9am. Please keep your belongings in your room.", time: "1 week ago" },
  { id: 5, text: "Gas cylinder replaced. Cooking gas is now available normally.", time: "2 weeks ago" },
];
    ...
    <div style={{ background: t.bg, minHeight: "100%", fontFamily: "'DM Sans', sans-serif", color: t.body }}>
      ...
      <div style={{ padding: "12px 16px 80px" }}>
        <p style={{ fontSize: 13, color: t.muted, marginBottom: 14 }}>
          Announcements from Sunrise Premium PG
        </p>
        ...
        {allAnnouncements.length === 0 ? (
          <div style={{
            ...
            <div style={{
              width: 72, height: 72, background: PURPLE_GHOST, borderRadius: "50%",
