...
import {
  ...
  List, Map, X, ChevronRight, Clock, ExternalLink,
  ThumbsUp, Share2, Heart, ArrowLeft, Send
} from "lucide-react";
...
function PlaceCard({ place, onTap }: { place: Place; onTap: () => void }) {
  return (
    ...
    >
      <div
        className="flex gap-3 p-3 rounded-2xl mb-3 transition-all active:scale-98"
        style={{
          background: "white",
          border: "1px solid #E2E8F0",
  ...
  return (
    <div className="min-h-screen" style={{ background: "#F8F7FF", fontFamily: "Inter, sans-serif" }}>
      ...
      <div className="px-4 pt-4 pb-24">
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: isActive ? `0 4px 12px ${cat.activeColor}40` : "0 1px 4px rgba(0,0,0,0.06)",
                    }}
                  >
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              <h2 className="font-bold text-base" style={{ color: "#0F172A" }}>
                {activeCat?.emoji} {activeCat?.id === "all" ? "Food & Eats" : activeCat?.label}
              </h2>
        ...
        {viewMode === "map" && (
          <div className="mb-4">
            <div className="rounded-2xl overflow-hidden" style={{ height: 280, border: "1px solid #E2E8F0" }}>
              <iframe
            ...
            <div className="flex gap-3 overflow-x-auto pt-3 pb-1 scrollbar-none">
              {filtered.map((place) => (
                <button
                  key={place.id}
