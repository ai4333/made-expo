...
interface TenantProfile {
  id: string; name: string; age: number; avatar: string; photo: string;
...
const PROFILES: TenantProfile[] = [
  {
    ...
    photo: "https://images.unsplash.com/photo-1752738372136-2602aaafdcb7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1737308584108-96f61d420638?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1580602264206-ca4e9a74248d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
  ...
  },
  {
    ...
    photo: "https://images.unsplash.com/photo-1573164713350-b14a82d3c15b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400",
...
const MESSAGES: Message[] = [
  { id: "1", name: "Rahul Nair", avatar: "RN", photo: "https://images.unsplash.com/photo-1752738372136-2602aaafdcb7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400", lastMessage: "Hey! Are you still looking at Sunshine PG?", time: "2m ago", unread: 2, pgName: "Sunshine PG", isOnline: true },
  { id: "2", name: "Karthik S", avatar: "KS", photo: "https://images.unsplash.com/photo-1737308584108-96f61d420638?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400", lastMessage: "Would love to be roommates — connect?", time: "1h ago", unread: 0, pgName: "Sunshine PG", isOnline: false },
  { id: "3", name: "Arjun Kumar", avatar: "AK", photo: "https://images.unsplash.com/photo-1580602264206-ca4e9a74248d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400", lastMessage: "Saw we're both looking at Green Nest 🙌", time: "3h ago", unread: 1, pgName: "Green Nest PG", isOnline: true },
];
...
function Avatar({ initials, photo, size = 40, border }: { initials: string; photo?: string; size?: number; border?: string }) {
  if (photo) {
    return (
      <img
        src={photo}
      ...
      <div className="w-full rounded-t-3xl bg-white overflow-y-auto" style={{ maxHeight: "90vh" }} onClick={e => e.stopPropagation()}>
        ...
        <div className="relative p-4 flex items-start gap-3" style={{ background: "linear-gradient(135deg, #1E1B4B 0%, #312E81 60%, #3D3784 100%)", minHeight: 140 }}>
          ...
          <div className="flex flex-col gap-2 flex-shrink-0">
            <Avatar initials={profile.avatar} photo={profile.photo} size={72} border="3px solid rgba(255,255,255,0.2)" />
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "#F8F7FF" }}>
      <div className="flex items-center gap-3 px-4 py-3 border-b" style={{ background: "white", borderColor: "#E2E8F0" }}>
        ...
        <Avatar initials={msg.avatar} photo={msg.photo} size={36} />
        <div className="flex-1">
    ...
    <div className="fixed inset-0 z-50 flex flex-col" style={{ background: "#F8F7FF" }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 flex flex-col gap-4">
        {[
          ...
          { label: "LOOKING FOR", opts: [["any","Open to Both"],["same-pg","Same PG Room"],["new-pg","New PG"]], val: lookPref, set: setLookPref, color: "#7C3AED" },
        ].map(s => (
...
// ─── MATCH CARD ───────────────────────────────────────────
function MatchCard({ profile, onSkip, onSayHi, hiSent, isAnimating }: {
  ...
  return (
    <div className="rounded-3xl overflow-hidden flex flex-col" style={{ background: "white", boxShadow: "0 8px 32px rgba(124,58,237,0.12), 0 2px 8px rgba(0,0,0,0.06)", border: "1px solid #EDE9FE" }}>
      ...
      <div className="relative p-4 flex items-start gap-3" style={{ background: "linear-gradient(135deg, #1E1B4B 0%, #312E81 60%, #3D3784 100%)", minHeight: 140 }}>
        <div className="flex flex-col gap-2 flex-shrink-0">
          <Avatar initials={profile.avatar} photo={profile.photo} size={72} border="3px solid rgba(255,255,255,0.3)" />
          <RoomStatusBadge roomStatus={profile.roomStatus} lookingFor={profile.lookingFor} />
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex justify-end mb-1">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
        ...
        <button
          ...
          style={{ color: hiSent ? "#22c55e" : "#7c3aed" }}
        >
...
export function ConnectHub() {
  ...
  const handleSayHi = () => {
    if (isAnimating || isSkipping) return;
    setHiSent(true);
    setIsAnimating(true);
    setTimeout(() => {
      setHiSent(false);
            ...
            {profile ? (
              <div
                ...
                style={{
                  ...
                  animation: isAnimating
                    ...
                    : isSkipping
                    ? "skipSlideOut 0.3s ease-in forwards"
              ...
              >
                <MatchCard
                  ...
                  onSayHi={handleSayHi}
                  hiSent={hiSent}
                  isAnimating={isAnimating || isSkipping}
                />
                ...
                {hiSent && (
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, rgba(109,40,217,0.93) 0%, rgba(139,92,246,0.96) 100%)",
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center px-6">
                ...
                <button onClick={() => setShowSettings(true)} className="mt-5 px-6 py-3 rounded-full font-semibold text-sm text-white" style={{ background: "#7C3AED" }}>
                  Update Preferences
                </button>
              </div>
            )}
                ...
                <div className="flex flex-col gap-2">
                  {matched.map(m => (
                    <div key={m.id} className="rounded-2xl p-3 flex items-center gap-3" style={{ background: "white", border: "1px solid #EDE9FE" }}>
                      <Avatar initials={m.avatar} photo={m.photo} size={40} />
                      <div className="flex-1 min-w-0">
            ...
            {filteredMessages.map(msg => (
              <button key={msg.id} onClick={() => setOpenChat(msg)} className="w-full rounded-2xl p-3 flex items-center gap-3 text-left"
                ...
                <div className="relative flex-shrink-0">
                  <Avatar initials={msg.avatar} photo={msg.photo} size={44} />
